...
namespace UnityExtensions.Utilities
{
    public static class Pools<TSource> where TSource : new()
    {
        ...
        ///     If <see cref="Pool{TSource}" /> doesn't exist, it is created with given <paramref name="factory" />. Default
        ///     <paramref name="factory" /> is () => new <typeparamref name="TSource" />()
        /// </summary>
        ...
        /// <summary>
        ///     Creates a new <see cref="Pool{TSource}" /> with specified <paramref name="name" /> and <paramref name="factory" />.
        ///     <br />
